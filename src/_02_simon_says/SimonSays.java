...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
		...
		JOptionPane.showMessageDialog(null, "Press the matching key when Simon tells you to; otherwise, press a different key.");
	...
	private void showImage() {
		...
		frame.setTitle("Manifesto of the Communist Party");
		// 9. Pack the frame
		frame.pack();
		...
		if (random.nextBoolean()) {
			speak("Simon says press this key, you rat");
			simonSays = true;
		} else {
			speak("Press this key, you rat");
			simonSays = false;
		}
